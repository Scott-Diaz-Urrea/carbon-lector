import { LENGUAJE_MODULES, LENGUAJE_POS, LENGUAJE_MODULES_G2, LENGUAJE_POS_G2, LENGUAJE_MODULES_G3, LENGUAJE_POS_G3, LENGUAJE_MODULES_G4, LENGUAJE_POS_G4, LENGUAJE_MODULES_G5, LENGUAJE_POS_G5, LENGUAJE_MODULES_G6, LENGUAJE_POS_G6, LENGUAJE_MODULES_G7, LENGUAJE_POS_G7, LENGUAJE_MODULES_G8, LENGUAJE_POS_G8, LENGUAJE_MODULES_M1, LENGUAJE_POS_M1 } from './content/lenguaje.js';
import { MATE_MODULES, MATE_POS, MATE_MODULES_G2, MATE_POS_G2, MATE_MODULES_G3, MATE_POS_G3, MATE_MODULES_G4, MATE_POS_G4, MATE_MODULES_G5, MATE_POS_G5, MATE_MODULES_G6, MATE_POS_G6, MATE_MODULES_G7, MATE_POS_G7, MATE_MODULES_G8, MATE_POS_G8, MATE_MODULES_M1, MATE_POS_M1 } from './content/matematica.js';
import { CIENCIAS_MODULES, CIENCIAS_POS, CIENCIAS_MODULES_G2, CIENCIAS_POS_G2, CIENCIAS_MODULES_G3, CIENCIAS_POS_G3, CIENCIAS_MODULES_G4, CIENCIAS_POS_G4, CIENCIAS_MODULES_G5, CIENCIAS_POS_G5, CIENCIAS_MODULES_G6, CIENCIAS_POS_G6, CIENCIAS_MODULES_G7, CIENCIAS_POS_G7, CIENCIAS_MODULES_G8, CIENCIAS_POS_G8, CIENCIAS_MODULES_M1, CIENCIAS_POS_M1 } from './content/ciencias.js';
import { HISTORIA_MODULES, HISTORIA_POS, HISTORIA_MODULES_G2, HISTORIA_POS_G2, HISTORIA_MODULES_G3, HISTORIA_POS_G3, HISTORIA_MODULES_G4, HISTORIA_POS_G4, HISTORIA_MODULES_G5, HISTORIA_POS_G5, HISTORIA_MODULES_G6, HISTORIA_POS_G6, HISTORIA_MODULES_G7, HISTORIA_POS_G7, HISTORIA_MODULES_G8, HISTORIA_POS_G8, HISTORIA_MODULES_M1, HISTORIA_POS_M1 } from './content/historia.js';
import { ARTES_MODULES, ARTES_POS, ARTES_MODULES_G2, ARTES_POS_G2, ARTES_MODULES_G3, ARTES_POS_G3, ARTES_MODULES_G4, ARTES_POS_G4, ARTES_MODULES_G5, ARTES_POS_G5, ARTES_MODULES_G6, ARTES_POS_G6, ARTES_MODULES_G7, ARTES_POS_G7, ARTES_MODULES_G8, ARTES_POS_G8, ARTES_MODULES_M1, ARTES_POS_M1 } from './content/artes.js';
import { MUSICA_MODULES, MUSICA_POS, MUSICA_MODULES_G2, MUSICA_POS_G2, MUSICA_MODULES_G3, MUSICA_POS_G3, MUSICA_MODULES_G4, MUSICA_POS_G4, MUSICA_MODULES_G5, MUSICA_POS_G5, MUSICA_MODULES_G6, MUSICA_POS_G6, MUSICA_MODULES_G7, MUSICA_POS_G7, MUSICA_MODULES_G8, MUSICA_POS_G8, MUSICA_MODULES_M1, MUSICA_POS_M1 } from './content/musica.js';
import { EDFISICA_MODULES, EDFISICA_POS, EDFISICA_MODULES_G2, EDFISICA_POS_G2, EDFISICA_MODULES_G3, EDFISICA_POS_G3, EDFISICA_MODULES_G4, EDFISICA_POS_G4, EDFISICA_MODULES_G5, EDFISICA_POS_G5, EDFISICA_MODULES_G6, EDFISICA_POS_G6, EDFISICA_MODULES_G7, EDFISICA_POS_G7, EDFISICA_MODULES_G8, EDFISICA_POS_G8, EDFISICA_MODULES_M1, EDFISICA_POS_M1 } from './content/edfisica.js';
import { ORIENTACION_MODULES, ORIENTACION_POS, ORIENTACION_MODULES_G2, ORIENTACION_POS_G2, ORIENTACION_MODULES_G3, ORIENTACION_POS_G3, ORIENTACION_MODULES_G4, ORIENTACION_POS_G4, ORIENTACION_MODULES_G5, ORIENTACION_POS_G5, ORIENTACION_MODULES_G6, ORIENTACION_POS_G6, ORIENTACION_MODULES_G7, ORIENTACION_POS_G7, ORIENTACION_MODULES_G8, ORIENTACION_POS_G8, ORIENTACION_MODULES_M1, ORIENTACION_POS_M1 } from './content/orientacion.js';
import { TECNOLOGIA_MODULES, TECNOLOGIA_POS, TECNOLOGIA_MODULES_G2, TECNOLOGIA_POS_G2, TECNOLOGIA_MODULES_G3, TECNOLOGIA_POS_G3, TECNOLOGIA_MODULES_G4, TECNOLOGIA_POS_G4, TECNOLOGIA_MODULES_G5, TECNOLOGIA_POS_G5, TECNOLOGIA_MODULES_G6, TECNOLOGIA_POS_G6, TECNOLOGIA_MODULES_G7, TECNOLOGIA_POS_G7, TECNOLOGIA_MODULES_G8, TECNOLOGIA_POS_G8, TECNOLOGIA_MODULES_M1, TECNOLOGIA_POS_M1 } from './content/tecnologia.js';
import { INGLES_MODULES_G5, INGLES_POS_G5, INGLES_MODULES_G6, INGLES_POS_G6, INGLES_MODULES_G7, INGLES_POS_G7, INGLES_MODULES_G8, INGLES_POS_G8, INGLES_MODULES_M1, INGLES_POS_M1 } from './content/ingles.js';
...
export const LENGUAJE_BY_GRADE_MEDIO = { 1: { modules: LENGUAJE_MODULES_M1, pos: LENGUAJE_POS_M1, height: 460 } };
export const MATE_BY_GRADE_MEDIO = { 1: { modules: MATE_MODULES_M1, pos: MATE_POS_M1, height: 700 } };
export const CIENCIAS_BY_GRADE_MEDIO = { 1: { modules: CIENCIAS_MODULES_M1, pos: CIENCIAS_POS_M1, height: 780 } };
export const HISTORIA_BY_GRADE_MEDIO = { 1: { modules: HISTORIA_MODULES_M1, pos: HISTORIA_POS_M1, height: 700 } };
export const ARTES_BY_GRADE_MEDIO = { 1: { modules: ARTES_MODULES_M1, pos: ARTES_POS_M1, height: 200 } };
export const MUSICA_BY_GRADE_MEDIO = { 1: { modules: MUSICA_MODULES_M1, pos: MUSICA_POS_M1, height: 200 } };
export const EDFISICA_BY_GRADE_MEDIO = { 1: { modules: EDFISICA_MODULES_M1, pos: EDFISICA_POS_M1, height: 260 } };
export const ORIENTACION_BY_GRADE_MEDIO = { 1: { modules: ORIENTACION_MODULES_M1, pos: ORIENTACION_POS_M1, height: 360 } };
export const TECNOLOGIA_BY_GRADE_MEDIO = { 1: { modules: TECNOLOGIA_MODULES_M1, pos: TECNOLOGIA_POS_M1, height: 200 } };
export const INGLES_BY_GRADE_MEDIO = { 1: { modules: INGLES_MODULES_M1, pos: INGLES_POS_M1, height: 320 } };
