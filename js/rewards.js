...
export const MODULE_TITLES = {
  ...
  adverbios4:'Cazador de Adverbios',
  verbos4:'Maestro de los Verbos',
  raicesafijos4:'Lingüista Junior',
  comprension4:'Lector Experto',
  numeros10mil4:'Numerólogo Junior',
  decimales4:'Maestro de los Decimales',
  simetria4:'Explorador de la Simetría',
  areavolumen4:'Arquitecto de Áreas',
  tiempo4:'Cronometrista Junior',
  ecosistemas4:'Guardián de Ecosistemas',
  cuerposistemas4:'Anatomista Junior',
  estadosmateria4:'Científico de la Materia',
  fuerzas4:'Ingeniero de Fuerzas',
  tierracapas4:'Geólogo Junior',
  civilizaciones4:'Explorador de Civilizaciones',
  geografiaamerica4:'Cartógrafo de América',
  recursosnaturales4:'Guardián de Recursos',
  ciudadania4:'Ciudadano Modelo IV',
  formacolor4:'Crítico de Arte Avanzado',
  dinamica4:'Maestro de la Dinámica',
  pulsocuerpo4:'Atleta Consciente IV',
  vidaactiva4:'Campeón Saludable IV',
  liderazgo4:'Líder de Equipo IV',
  emociones4:'Experto en Emociones IV',
  autocuidado4:'Guardián de mi Cuerpo IV',
  convivencia4:'Embajador de la Amistad IV',
  habitosescolares4:'Estudiante Ejemplar IV',
